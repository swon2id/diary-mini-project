...
public class ScheduleController {
    ...
    public ResponseEntity<Map<String, Object>> handleGetMonthlyScheduleList(@Valid @RequestBody GetMonthlyDataListRequest dto) {
        ...
        if (!authService.validateCredentials(dto.getLoggedInMember())) {
            ...
            List<ScheduleDto> schedules = scheduleService.getMonthlyScheduleList(dto.getLoggedInMember(), dto.getDate());
            response.put("success", true);
    ...
    @PostMapping("delete")
    public ResponseEntity<Map<String, Object>> handleDeleteSchedule(@Valid @RequestBody DeleteScheduleRequest dto) {
        Map<String, Object> response = new HashMap<>();
        HttpStatus httpStatus;
